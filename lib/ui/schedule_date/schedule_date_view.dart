...
class ScheduleDateView extends BaseView<ScheduleDateViewModel> {
  // DisplayProfileResponse inforProfile;
  const ScheduleDateView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final ScheduleDateViewModel viewModel =
        ref.watch(scheduledateViewModelProvider);
